    ...
    >
      <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-7 shadow-2xl transition-all">
        ...
        <div className="flex items-center gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
          <div className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-600 to-cyan-500 text-lg font-extrabold text-white shadow-lg shadow-indigo-500/25">
            AS
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 id="founder-modal-title" className="text-lg font-bold text-slate-900 dark:text-white">
                Abhinav Sharma
              </h3>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              OpsPulse Inc. • Cloud Infrastructure Intelligence
            </p>
          </div>
        </div>
        ...
        <div className="mt-5 space-y-3.5">
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-medium uppercase text-slate-400 dark:text-slate-500">Corporate Email</span>
            ...
            <button
              onClick={() => copyToClipboard('founder@opspulse.in', 'email')}
          ...
          <div className="flex items-center justify-between rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-medium uppercase text-slate-400 dark:text-slate-500">AWS Root Account ID</span>
                <p className="font-mono text-xs font-semibold text-slate-800 dark:text-slate-200">
                  767491589088
                </p>
              </div>
            ...
            <button
              onClick={() => copyToClipboard('767491589088', 'aws')}
              className="flex items-center gap-1 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-2.5 py-1 text-xs font-medium text-slate-700 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400 transition"
            >
              {copiedField === 'aws' ? <Check className="h-3 w-3 text-emerald-500" /> : <Copy className="h-3 w-3" />}
              <span>{copiedField === 'aws' ? 'Copied' : 'Copy'}</span>
            </button>
          </div>
          ...
          <div className="rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[10px] font-medium uppercase text-slate-400 dark:text-slate-500">Live Infrastructure</span>
                  <p className="text-xs font-semibold text-slate-800 dark:text-slate-200">
                    Amplify (eu-north-1) + CloudFront CDN
                  </p>
                </div>
              </div>
              <button
                ...
                className="flex items-center gap-1 rounded-lg bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition"
              >
        ...
        <div className="mt-6 flex items-center justify-between border-t border-slate-100 dark:border-slate-800 pt-4">
          <div className="flex items-center gap-1 text-[11px] text-slate-500 dark:text-slate-400">
            ...
            <span>OpsPulse v1.1.0 Enterprise</span>
          </div>
          <button
            onClick={onClose}
